...
**Domain:** Host-only by default under canonical `www.cs2ze.org`; **no cookie Domain** unless explicitly set.  
...
SESSION_COOKIE_DOMAIN=""  # keep empty for host-only (www.cs2ze.org)
SESSION_COOKIE_DOMAIN_ALLOW_CROSS_SUBDOMAIN="false"
CANONICAL_HOST="www.cs2ze.org"
CANONICAL_SCHEME="https"
```

> Do **not** set `SESSION_COOKIE_DOMAIN=.cs2ze.org` unless explicitly required and `SESSION_COOKIE_DOMAIN_ALLOW_CROSS_SUBDOMAIN=true`.
...
Environment="CANONICAL_HOST=www.cs2ze.org"
