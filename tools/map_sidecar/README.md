...
Required:
- `PROJECT_ROOT` (default: `/opt/example-app/NERV_CS2ZE`)
- `MYSQL_HOST`
...
```bash
PROJECT_ROOT=/opt/example-app/NERV_CS2ZE
...
MAIN_SERVERS_JSON_URL=https://example.com/servers.json
MAP_SIDECAR_LOG_DIR=/opt/example-app/NERV_CS2ZE/logs
...
- `OVERSEAS_INGEST_URL` (e.g. `https://example.com/sidecar/exg/ingest`)
- `INGEST_TOKEN`
...
EXG_MAPLIST_URL=https://example.com/serverlist/cs2maplist
OVERSEAS_INGEST_URL=https://example.com/sidecar/exg/ingest
INGEST_TOKEN=REPLACE_ME
